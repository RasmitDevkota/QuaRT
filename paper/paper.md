...
There is also a set of demo notebooks including a fully-classical implementation for comparison with the quantum algorithm and some unit tests of experimental features.

# Scholarly Work

`QuaRT` is currently being used to study lattice Boltzmann methods for radiative transfer [@Devkota2025, in prep.].

# Acknowledgements

JHW acknowledges support from NSF grants AST-2108020 and AST-2510197 and NASA grant 80NSSC21K1053.  This research was supported in part through research cyberinfrastructure resources and services provided by the Partnership for an Advanced Computing Environment (PACE) at the Georgia Institute of Technology, Atlanta, Georgia, USA [@PACE].
